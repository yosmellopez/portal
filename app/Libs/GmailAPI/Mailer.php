...
namespace App\Libs\GmailAPI;

use App\Libs\GmailAPI\Traits\MailReplyable;
use Carbon\Carbon;
...
class Mailer extends GmailConnection
{
    use HasDecodableBody,
        Modifiable,
        HasParts,
        MailReplyable {
        MailReplyable::__construct as private __rConstruct;

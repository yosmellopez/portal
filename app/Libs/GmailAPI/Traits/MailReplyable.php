...
namespace App\Libs\GmailAPI\Traits;
...
trait MailReplyable
{
     ...
     *
     * @return \App\Libs\GmailAPI\Mailer
     */
    ...
    {
        $attachment = Swift_Attachment::fromPath($imagePath)->setDisposition('inline');
        $attachment->getHeaders()->addTextHeader('Content-ID', '<'.$cid.'>');
        $attachment->getHeaders()->addTextHeader('X-Attachment-Id', $cid);
        return $this->swiftMessage->embed($attachment);
    }

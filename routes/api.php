...
Route::get('descarga/pdf', 'ConsultaController@downloadFormatoImpreso');
Route::get('descarga/xml', 'ConsultaController@downloadXmlFirmado');
Route::get('descarga/cdr', 'ConsultaController@downloadRespuestaCdr');

...
Route::post('consulta/documento', 'ConsultaController@consultaDocummento');
Route::post('descarga/pdf', 'ConsultaController@downloadFormatoImpreso');
Route::post('descarga/xml', 'ConsultaController@downloadXmlFirmado');
Route::post('descarga/cdr', 'ConsultaController@downloadRespuestaCdr');
